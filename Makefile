...
requirements:	
	pip install --upgrade -r requirements.txt --find-links https://pytorch-geometric.com/whl/torch-1.8.1+cu101.html --find-links https://download.pytorch.org/whl/torch_stable.html 
